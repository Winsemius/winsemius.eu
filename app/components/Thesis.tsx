  ...
  return (
    <section className="relative bg-surface py-24 md:py-32 border-t border-border" ref={ref}>
      <div className="mx-auto max-w-6xl px-6">
        <div className="reveal grid gap-12 md:grid-cols-[1fr_340px] md:gap-16 items-center">
          <div>
            {/* Briefing label */}
            ...
            <p className="text-2xl leading-relaxed tracking-[-0.02em] text-text md:text-3xl font-display font-medium">
