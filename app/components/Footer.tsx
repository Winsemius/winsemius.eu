      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-12 md:grid-cols-4">
          <div>
            ...
            />
            <p className="mt-4 text-sm leading-relaxed text-[#B8C4D4]">
            ...
            <ul className="mt-4 space-y-2">
              {[
                ...
                <li key={s}>
                  <a
                    href="#services"
                    className="text-sm text-[#B8C4D4] transition-colors hover:text-white"
                  >
                    {s}
                  </a>
                </li>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-sm text-[#B8C4D4] transition-colors hover:text-white"
                >
        ...
        <div className="mt-16 border-t border-white/10 pt-8 text-center">
          <p className="text-xs text-white/30">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="underline underline-offset-2 transition-colors hover:text-[#B8C4D4]"
            >
              CC BY-NC-SA 4.0
            </a>
          </p>
